...
const SlideSurah = ({ onSelect }) => {
  ...
  return (
    <div className="relative">
      {/* Dropdown Button */}
      <div className="bg-white px-4 py-2 flex items-center justify-between w-56 rounded-lg shadow-md">
      ...
      {isOpen && (
        <motion.div
          ...
          className="absolute left-0 top-full max-h-[400px] w-56 bg-white rounded-lg shadow-lg mt-2 p-4 overflow-y-auto scrollbar-hide"
        >
          <input
            type="text"
