    ...
    <>
      <div className="min-h-screen bg-[#8ba378] p-4 rounded-2xl">
        ...
        <div className="flex justify-between items-center bg-orange-100 p-4 rounded-lg shadow-md">
          ...
          <span className="text-green-700 font-bold text-[2rem]">
            {surah?.namaLatin}
          </span>
        </div>
        ...
        <div className="mt-4">
          {ayat.map((ayat) => (
            <div
              key={ayat.nomorAyat}
              className="bg-orange-100 p-4 rounded-lg shadow-md mb-3"
            >
              ...
              <p className="text-right text-3xl font-semibold text-justify text-green-700 mt-3 arabic">
                {ayat.teksArab}
              </p>
              <p className="text-gray-600 italic text-justify mt-2">
                {ayat.teksLatin}
              </p>
